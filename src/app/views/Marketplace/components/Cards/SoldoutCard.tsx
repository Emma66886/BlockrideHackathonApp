    ...
    "
      >
        <div className="topsection flex justify-between">
          ...
          <div className="rightactive bg-[#141414] w-16 h-6  rounded-sm justify-center items-center inline-flex">
            <div className="text-white text-xs font-medium">Sold Out</div>
          </div>
        </div>
